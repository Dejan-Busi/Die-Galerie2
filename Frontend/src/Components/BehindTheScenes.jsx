  ...
  return (
    <div id="behindTheScenes">
      ...
      <div id="flexBox_behindTheScenes">
        ...
        <p id="motivText">
          Das Motiv für die Entwicklung dieser App war ein persönlicher
          Skill-Test, um meine eigenen Fähigkeiten auf dem Prüfstand zu stellen. Der Schwerpunkt
          lag auf der Implementierung aller CRUD-Operationen, einer einfachen
          Form der Authentifizierung, Conditional Rendering basierend auf
          User-Interaktion sowie einer stylischen UI. Die Idee einer
          Bildergalerie kommt daher, dass die App einerseits einen Fokus auf die
          Optik legen sollte, wodurch ein visuell-lastiges Konzept wie eine Bildergalerie als natürliche Lösung
          erschien, und andererseits der User beim Interagieren mit der App,
          beispielsweise beim Lesen der Hintergrundgeschichten der Gemälde,
          etwas lernen kann.
